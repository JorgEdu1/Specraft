...
<header class="cabeca">
    ...
    <div class="cont"></div>
        <nav class="guia">
            <div> <img class="tr" src="gta persona.png" alt=""></div>
           <div> <form method="POST" action="gtav_calc.php">
               <p>O jogo se passa no estado ficcional de San Andreas, com a história da<br> campanha um jogador seguindo três criminosos e seus esforços para<br> realizarem assaltos sob a pressão de uma agência governamental. O<br> mundo aberto permite que os jogadores naveguem livremente pelas<br> áreas rurais e urbanas de San Andreas.</p><br>
...
switch ($nome) {
    case 'Basico':
        ...
        break;
    case 'Moderado':
        echo "CPU: Ryzen 3 3200G <br>Memoria: 16GB de ram DDR4(Preferencia para 2x8GB)<br>GPU: GEFORCE GTX 1050TI";
        break;
    case 'Avançado':
